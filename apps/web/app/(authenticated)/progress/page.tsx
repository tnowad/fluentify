...
import { ArrowDown, ArrowUp, Calendar, Check, ChevronDown, Clock, Flame, HelpCircle, Info, X } from "lucide-react"
      ...
      <main className="container">
        ...
        <section className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl font-bold">{overallStats.totalWordsLearned}</div>
                {renderTrend(overallStats.wordsLearnedChange)}
              </div>
              <p className="mt-1 text-xs text-muted-foreground">vs. previous {timeRange}</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Recall Accuracy</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl font-bold">{overallStats.averageAccuracy}%</div>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="text-3xl font-bold">{overallStats.currentStreak}</div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                <div className="text-3xl font-bold">{overallStats.totalTimeSpent}h</div>
            ...
            <TabsContent value="daily" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Track your daily words learned and accuracy</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[350px]">
                    ...
                    >
                      <ResponsiveContainer width="100%" height="100%">
                        <LineChart data={dailyProgressData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                          ...
                          <Line
                            ...
                            activeDot={{ r: 8 }}
                          />
                          <Line yAxisId="right" type="monotone" dataKey="accuracy" stroke="var(--color-accuracy)" />
                        </LineChart>
                      </ResponsiveContainer>
                    </ChartContainer>
                  </div>
            ...
            <TabsContent value="category" className="mt-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Compare your progress across different topics</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="h-[350px]">
                    <ChartContainer
                    ...
                    >
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={categoryPerformanceData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                          ...
                          <ChartTooltip content={<ChartTooltipContent />} />
                          <Legend />
                          <Bar yAxisId="left" dataKey="wordsLearned" fill="var(--color-wordsLearned)" />
                          <Bar yAxisId="right" dataKey="accuracy" fill="var(--color-accuracy)" />
                        </BarChart>
                      </ResponsiveContainer>
                    </ChartContainer>
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg bg-amber-50 p-4">
                <h3 className="mb-1 font-medium text-amber-800">Focus on Hard Words</h3>
                <p className="text-sm text-amber-700">
                  Your accuracy with difficult words is 25% lower than with medium difficulty words. Consider spending
                  more time reviewing words like "Procurement" and "Compliance".
                </p>
              </div>

              <div className="rounded-lg bg-blue-50 p-4">
                <h3 className="mb-1 font-medium text-blue-800">Consistent Progress</h3>
                <p className="text-sm text-blue-700">
                  You've maintained a 16-day learning streak! Consistency is key to vocabulary retention. Keep up the
                  good work to improve your long-term memory.
                </p>
              </div>

              <div className="rounded-lg bg-green-50 p-4">
                <h3 className="mb-1 font-medium text-green-800">Strong in Travel Vocabulary</h3>
                <p className="text-sm text-green-700">
                  You're performing exceptionally well in the Travel category with 90% accuracy. Consider challenging
                  yourself with more advanced words in this category.
                </p>
              </div>
            </CardContent>
          </Card>
