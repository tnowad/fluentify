...
const wordData = {
  ...
  definitions: [
    ...
    {
      definition: "To help bring about or make easier",
      example: "The mediator's role is to facilitate a peaceful resolution to the conflict.",
    },
  ],
  synonyms: ["ease", "simplify", "expedite", "assist", "enable", "help"],
  examples: [
    "The manager's job is to facilitate the smooth running of the department.",
    "We need someone to facilitate the discussion at tomorrow's meeting.",
    "The new trade agreement will facilitate exports to neighboring countries.",
  ],
  aiFeedback: {
    commonMistakes: "Often confused with 'facile' which means 'simplistic' or 'easy but superficial'.",
    grammarTips:
      "As a transitive verb, 'facilitate' always requires an object. You facilitate something, not just facilitate.",
    usageTips: "Commonly used in business and academic contexts. Less common in casual conversation.",
  },
  relatedWords: [
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-10 border-b bg-background">
        <div className="container flex h-14 max-w-screen-md items-center">
          <Link href="/dashboard" className="mr-auto flex items-center gap-1 text-muted-foreground">
      ...
      <main className="container max-w-screen-md py-6">
        ...
        <section className="mb-8">
          ...
          <div className="mt-1 text-muted-foreground">{wordData.phonetic}</div>
        </section>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{wordData.aiFeedback.commonMistakes}</p>
              </div>
              <Separator />
              <div>
                <h4 className="mb-1 font-medium">Grammar Tips</h4>
                <p className="text-sm text-muted-foreground">{wordData.aiFeedback.grammarTips}</p>
              </div>
              <Separator />
              <div>
                <h4 className="mb-1 font-medium">Usage Tips</h4>
                <p className="text-sm text-muted-foreground">{wordData.aiFeedback.usageTips}</p>
              </div>
            </CardContent>
          </Card>
        </section>
